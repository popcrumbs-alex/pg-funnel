...
import Colors, { GoldBarsColors } from "../../../constants/Colors";
...
const OrderPage = () => {
  ...
  return (
    <ThemeContext.Provider value={GoldBarsColors}>
      <Globalstyle />
      <HelmetWrapper pageTitle="Gold Trump Bar Order Page" efScript="" />
      <Nav />
      <Main>
        <Alert />
        <Hero />
